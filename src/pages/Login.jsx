...
export default function Login({set_is_auth}) {
  ...
  return (
    <div className='flex flex-col mx-auto w-1/2 bg-slate-100 h-96 mt-32 rounded-3xl justify-center px-10 gap-5 shadow-lg'>
        <h2 className='text-5xl text-gray-700 font-md '>Login</h2>
        <div className='flex flex-col gap-5'>
            <form className=''>
                ...
                <button 
                    ...
                    type='submit' onClick={handleSignIn}>Login</button>
            </form>
        </div>
    </div>
  )
